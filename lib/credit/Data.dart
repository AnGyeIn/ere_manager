...
var math1 = CreditManager(LECTURE, '(고급)수학 및 연습1', null, 3);
var math2 = CreditManager(LECTURE, '(고급)수학 및 연습2', null, 3);
var mathPra1 = CreditManager(LECTURE, '수학 1과 수학연습 1', null, 3);
var mathPra2 = CreditManager(LECTURE, '수학 2와 수학연습 2', null, 3);
var engMat1 = CreditManager(LECTURE, '공학수학1', null, 3);
var engMat2 = CreditManager(LECTURE, '공학수학2', null, 3);
var physics1 = CreditManager(LECTURE, '(고급)물리학1(물리의 기본1)', null, 3);
var phyExp1 = CreditManager(LECTURE, '물리학실험1', null, 1);
var physics2 = CreditManager(LECTURE, '(고급)물리학2(물리의 기본2)', null, 3);
var phyExp2 = CreditManager(LECTURE, '물리학실험2', null, 1);
var physics = CreditManager(LECTURE, '물리학', null, 3);
var phyExp = CreditManager(LECTURE, '물리학실험', null, 1);
var chemistry1 = CreditManager(LECTURE, '화학1', null, 3);
var cheExp1 = CreditManager(LECTURE, '화학실험1', null, 1);
var chemistry2 = CreditManager(LECTURE, '화학2', null, 3);
var cheExp2 = CreditManager(LECTURE, '화학실험2', null, 1);
var chemistry = CreditManager(LECTURE, '화학', null, 3);
var cheExp = CreditManager(LECTURE, '화학실험', null, 1);
var biology1 = CreditManager(LECTURE, '생물학1', null, 3);
var bioExp1 = CreditManager(LECTURE, '생물학실험1', null, 1);
var biology2 = CreditManager(LECTURE, '생물학2', null, 3);
var bioExp2 = CreditManager(LECTURE, '생물학실험2', null, 1);
